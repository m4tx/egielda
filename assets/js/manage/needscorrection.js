...
/**
 * Used in Users => Verify => Needs correction.
 */

var egielda = egielda || {};

egielda.needsCorrection = function() {
    'use strict';

    // 'on', 'off' or 'switching'
    var choosingIncorrect = 'off',
        fields = ['username', 'first_name', 'last_name', 'year', 'class_letter',
            'phone_number', 'email'];
    ...
    $('#needs-correction').click(function(e) {
        ...
        if (choosingIncorrect === 'off') {
            ...
            form.append($('<input type="hidden" name="incorrect_fields">')
                    .prop('value', toCorrect.join(',')));
